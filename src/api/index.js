...
export const reqAddress=(geohash)=>ajax(`${BASE_URL}/position/${geohash}`)                            //param型参数

// [2、获取食品分类列表](#2获取食品分类列表)
export const reqFoodCategorys=()=>ajax(BASE_URL+'/index_category')

// [3、根据经纬度获取商铺列表](#3根据经纬度获取商铺列表)
export const reqShops=(longitude,latitude)=>ajax(BASE_URL+'/shops',{longitude,latitude})        //query型参数，data中的参数名必须与文档中的一致
